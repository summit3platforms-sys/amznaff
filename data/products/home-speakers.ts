import raw from './home-speakers.json';
import { Product } from '../types';

// ---------------------------------------------------------------------------
// Home Speakers category — researched August 2026.
//
// Product data lives in home-speakers.json, not here, so the admin dashboard
...
export const homeSpeakerProducts: Product[] = raw as Product[];
