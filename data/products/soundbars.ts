import raw from './soundbars.json';
import { Product } from '../types';

// ---------------------------------------------------------------------------
// Soundbars category — researched August 2026.
//
// Product data lives in soundbars.json, not here, so the admin dashboard
...
export const soundbarProducts: Product[] = raw as Product[];
