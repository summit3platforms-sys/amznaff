import raw from './wireless-earbuds.json';
import { Product } from '../types';

// ---------------------------------------------------------------------------
// Wireless Earbuds category — researched August 2026.
//
// Product data lives in wireless-earbuds.json, not here, so the admin dashboard
...
export const wirelessEarbudProducts: Product[] = raw as Product[];
